...
require (
	...
	github.com/containers/storage v1.40.3 // indirect
...
replace (
	...
	github.com/replicatedhq/troubleshoot => github.com/storageos/troubleshoot v0.9.48-0.20220712083915-79d30ba04eaf
